...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http, ServerProperties serverProperties,
        ...
        // Configure the app as with an authentication manager resolver capable of
        ...
        http.exceptionHandling(
                excepHandling -> excepHandling.authenticationEntryPoint((request, response, authException) -> {
        ...
        // @formatter:off
        http.authorizeHttpRequests(request -> request.requestMatchers(permitAll).permitAll().anyRequest().authenticated());
        // @formatter:on
